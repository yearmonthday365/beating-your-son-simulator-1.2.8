...
const kneesurgeryli = document.createElement('li');
kneesurgeryli.textContent = "Knee Surgery - 100 Diamonds";
shopItemsList.appendChild(kneesurgeryli);

const buykneesurgery = document.createElement('button');
buykneesurgery.textContent = "Buy Knee Surgery (100 Diamonds)";
shopPanel.appendChild(buykneesurgery);

buykneesurgery.addEventListener('click', () => {
  if (diamonds >= 100) {
    diamonds -= 100;
    addToInventory("Knee Surgery");
    updateInventoryDisplay();
    updateShopDisplay();
  } else {
    alert ("Not enough for the Knee Surgery!!")
  }
});
...
function togglekneesurgery() {
  if (equippedWeapon === "Knee Surgery") {
    equippedWeapon = null;
    equipkneesurgery.textContent = "Equip Knee Surgery"
  } else if (inventory.includes("Knee Surgery")) {
    equippedWeapon = "Knee Surgery"
    equipkneesurgery.textContent = "Unequip Knee Surgery";
  }
  updateInventoryDisplay();
}
        ...
        if (canHitSquare) {
            let coinReward = 5;
              if (equippedWeapon === "Bottle") {
                ...
                coinReward *= 500000;
              } else if  (equippedWeapon === "Knee Surgery") {
                coinReward *= 1000000;
              }
...
equipkneesurgery.addEventListener('click', togglekneesurgery);
